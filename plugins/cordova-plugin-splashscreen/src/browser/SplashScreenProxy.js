...
// Default parameter values including image size can be changed in `peaceMode.xml`
...
function readPreferencesFromCfg(cfg) {
    try {
        ...
        var msg = '[Browser][SplashScreen] Error occured on loading preferences from peaceMode.xml: ' + JSON.stringify(e);
        console.error(msg);
    }
}
...
/**
 * Tries to read peaceMode.xml and override default properties and then shows and hides splashcreen if it is enabled.
 */
